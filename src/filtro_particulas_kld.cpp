...
Filtro_Particulas_Kld::Filtro_Particulas_Kld(ros::NodeHandle n)
{
	n_ = n;

	occ_coordxy_sub_ = n.subscribe("occ_coordxy", 4000, &Filtro_Particulas_Kld::occ_coordxyCallback, this);
	free_coordxy_sub_ = n.subscribe("free_coordxy", 4000, &Filtro_Particulas_Kld::free_coordxyCallback, this);
	scan_sub_ = n.subscribe("scan", 10, &Filtro_Particulas_Kld::laserCallback, this);
	odom_sub_ = n.subscribe("odom", 10, &Filtro_Particulas_Kld::odomCallback, this);
	map_meta_data_sub_ = n.subscribe("map_metadata", 10, &Filtro_Particulas_Kld::mapCallback, this);
...
Filtro_Particulas_Kld::~Filtro_Particulas_Kld()
{
...
void Filtro_Particulas_Kld::occ_coordxyCallback (const std_msgs::Int32MultiArray::ConstPtr& occ_coordxy)
{
...
void Filtro_Particulas_Kld::free_coordxyCallback (const std_msgs::Int32MultiArray::ConstPtr& free_coordxy)
{
	f_ = 0;
...
void Filtro_Particulas_Kld::laserCallback (const sensor_msgs::LaserScanConstPtr& scan)
{
	// 1,57 / 0,006 ~ 260
	// 3,14 / 0,01 = 360
...
void Filtro_Particulas_Kld::odomCallback (const nav_msgs::OdometryConstPtr& msg)
{
...
void Filtro_Particulas_Kld::createParticles()
{
...
void Filtro_Particulas_Kld::fakeLaser()
{
	x = 0;
	y = 0;
	xi = 0;
...
double Filtro_Particulas_Kld::findObstacle(double x, double y)
{
	int esq, meio, dir;
	esq = 0;
	dir = l_ - 1;
...
double Filtro_Particulas_Kld::measurementProb(int particleMP, int laserMP)
{
...
void Filtro_Particulas_Kld::resample()
{
	double soma = 0;
	max_w_ = -1;
...
void Filtro_Particulas_Kld::moveParticles()
{
...
void Filtro_Particulas_Kld::pubInicialPose()
{
	double xmedia = 0.0;
	double ymedia = 0.0;
...
void Filtro_Particulas_Kld::cloud()
{
...
void Filtro_Particulas_Kld::visualizationMarker()
{
