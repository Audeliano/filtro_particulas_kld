#ifndef FILTRO_PARTICULAS_KLD_H
#define FILTRO_PARTICULAS_KLD_H
...
#include "filtro_particulas_kld/pose.h"
#include "filtro_particulas_kld/energia.h"

#define sign(a) (((a) < 0) ? -1 : (((a) > 0) ? 1 : 0))

using namespace std;

class Filtro_Particulas_Kld
{
	public:
		Filtro_Particulas_Kld(ros::NodeHandle n);
		virtual ~Filtro_Particulas_Kld();
